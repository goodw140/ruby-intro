...
puts "1 Bitcoin is valued at $#{bitcoin_data ["bpi"]["USD"]["rate_float"]} #{bitcoin_data ["bpi"]["USD"]["code"]}"
puts "You Bitcoin is worth $#{bitcoin * bitcoin_data ["bpi"]["USD"]["rate_float"]} #{bitcoin_data ["bpi"]["USD"]["code"]}"